...
initial_pressure = st.slider("Initial Pressure (P1) in Pascals:", min_value=1000, max_value=10000, value=50000, step=1000)
initial_volume = st.slider("Initial Volume (V1) in liters:", min_value=1.0, max_value=100.0, value=5.0, step=0.1)
